...
nt||(ot&&(ot.style.display="none"),Q.commentId=0),it&&console.info("[图文评论] 评论ID:",Q.commentId);
var mt=function(){
...
Q.onlyFansDaysCanComment&&0===Q.isFansDays?((t||e).innerHTML="作者已设置关注7天后才可留言",at(e,"block")):Q.onlyFansCanComment&&0===Q.isFans?((t||e).innerHTML="作者已设置关注后才可以留言",
